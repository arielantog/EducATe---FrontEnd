...
<%DocenteDTO user = (DocenteDTO) session.getAttribute("currentSessionUser");%>
	<head>
		...
		<title>Participación y respuestas por cursos</title>
		<meta charset="utf-8" />
			...
			<!-- Wrapper -->
				...
				<!-- Main -->
					...
					<section id="main" class="wrapper">
	            		<div class="inner">
							<h1 class="major">Participación y respuestas por cursos</h1>
						</div>
					</section>
					<section class="lista-button">
						<iframe 
							width="1000" height="600" 
							src="https://app.powerbi.com/view?r=eyJrIjoiZGYxNjJmOWItOTMzNy00MTdmLWI3MzQtOTg2MzMzMWQ1ODg0IiwidCI6IjM0NDk3OWQwLWQzMWQtNGM1Ny04YmEwLTQ5MWFmZjRhY2FlZCIsImMiOjR9" 
