...
<%DocenteDTO user = (DocenteDTO) session.getAttribute("currentSessionUser");%>
	<head>
		...
		<title>Efectividad por lección</title>
		<meta charset="utf-8" />
			...
			<!-- Wrapper -->
				...
				<!-- Main -->
					...
					<section id="main" class="wrapper">
	            		<div class="inner">
							<h1 class="major">Efectividad por lección</h1>
						</div>
					</section>
					<section class="lista-button">
						<iframe 
							width="1000" height="600" 
							src="https://app.powerbi.com/view?r=eyJrIjoiMmYzMDNhMjUtNTAyYi00MmE5LTkxZWQtYTBmZTE5NWU2MWJlIiwidCI6IjM0NDk3OWQwLWQzMWQtNGM1Ny04YmEwLTQ5MWFmZjRhY2FlZCIsImMiOjR9"
