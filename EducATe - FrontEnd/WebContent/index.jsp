			...
			<div id="wrapper">
				...
				<!-- Alumnos -->
					<section id="alumnos" class="wrapper style2 fullscreen">
						<div class="inner">
							<h2>Alumnos</h2>
							<p>Si sos un alumno, ingresá tu usuario y contraseña y EducATe.</p>
				...
				<!-- Docentes -->
					<section id="docentes" class="wrapper style3 fullscreen">
						<div class="inner">
							<h2>Docentes</h2>
							<p>Si sos un docente, ingresá tu usuario y contraseña y realizá un seguimiento de tus alumnos.</p>
							<div class="split style1">
								<section>
